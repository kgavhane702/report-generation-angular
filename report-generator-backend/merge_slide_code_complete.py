...
are validated before merging so unsafe structural corruption does not produce
outputs that PowerPoint must repair. Known repairable recovery artifacts and
stale section memberships are normalized during the merge.
"""
