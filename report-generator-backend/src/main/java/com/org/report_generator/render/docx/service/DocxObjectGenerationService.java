...
public class DocxObjectGenerationService {
    ...
    private static final Map<String, VmlShapeInfo> SHAPE_TO_VML = Map.ofEntries(
        ...
        // Callouts - with pointer at bottom-left corner
        Map.entry("callout-rectangle", new VmlShapeInfo("shape", "61", 
            "m,l21600,r,14400l13200,14400,10800,21600,8400,14400,,14400,,xe")),
        Map.entry("callout-rounded", new VmlShapeInfo("shape", "62",
            "m2700,qx,2700l,12960,0,15120,5400,21600,5400,15120,5400,12960,,12960qy,15120l,12960qy2700,15120l18900,15120qx21600,12960l21600,2700qy18900,l2700,xe")),
        Map.entry("callout-cloud", new VmlShapeInfo("shape", "106",
            "m1950,7185c1950,5355,2775,3750,4350,2595,5925,1440,8100,660,10800,660v2700,,4875,780,6450,1935c18825,3750,19650,5355,19650,7185v,1245,-375,2400,-1050,3405c19275,11595,19650,12750,19650,14040v,1830,-825,3435,-2400,4590c15675,19785,13500,20565,10800,20565v-2700,,-4875,-780,-6450,-1935c2775,17475,1950,15870,1950,14040v,-1290,375,-2445,1050,-3450c2325,9585,1950,8430,1950,7185xem1800,14400l0,21600,5400,14400xe")),
