...
export class ChartJsColumnChartHandler implements ChartJsChartTypeHandler {
  readonly chartType = 'column';
  readonly chartJsType: ChartConfiguration['type'] = 'bar';
  ...
  convertToChartJsConfig(
    ...
    return {
      ...
      options: {
        indexAxis: 'x', // Column chart (vertical bars) - this is the default
        responsive: true,
